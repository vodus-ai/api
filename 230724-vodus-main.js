...
(function (global) {
    ...
    if (app.env == 'live') {
        ...
        app.surveycssUrl = 'https://cdn.jsdelivr.net/gh/vodus-ai/api@latest/230626-survey.css';
            ...
            $(".answer-box").click(function () {
                ...
                if (!isGridBoolean) {
                    ...
                    if ($(this).index() == 0) {
                        ...
                        var defaultRowAnswer = response.data.SurveyQuestionAnswers.filter(x => x.Id == idFromAnswers)[0].AnswerValue;
