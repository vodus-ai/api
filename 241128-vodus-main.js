...
(function (global) {
    ...
    if (app.env == 'live') {
        ...
        app.surveycssUrl = 'https://cdn.jsdelivr.net/gh/vodus-ai/api@latest/241127-survey.css';
        app.commonjsUrl = 'https://cdn.jsdelivr.net/gh/vodus-ai/api@latest/231126-vodus-common.js';
